...
fn render_markdown(d: &ReportData) -> String {
    ...
    md.push_str("---\n*Generated by [wshm](https://github.com/pszymkowiak/wshm-tools)*\n<!-- wshm -->\n");
    md
}
...
"#,
    ...
    h.push_str("<div class=\"footer\">Generated by <a href=\"https://github.com/pszymkowiak/wshm-tools\">wshm</a></div>\n</body>\n</html>\n");
    h
}
